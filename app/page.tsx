...
// ─── PROJECTS SECTION ────────────────────────────────────────────────────────
const PROJECTS = [
  { emoji: '🏋️', name: 'BookEase', label: 'Fitness Booking + AI', desc: 'Full-stack booking platform with AI training plan generator powered by Groq LLaMA 3.1. Admin dashboard, Supabase database, cookie auth.', url: 'https://bookease-lake.vercel.app', tags: ['Next.js 14','Supabase','Groq AI','Admin Dashboard'], accent: '#56B06A', bg: 'linear-gradient(135deg,#0D1F12,#1A4028)' },
  { emoji: '📊', name: 'Vela Analytics', label: 'SaaS Dashboard', desc: 'Premium e-commerce analytics dashboard with Recharts visualisations, Supabase Auth, orders/customer tables and 90-day demo data.', url: 'https://vela-sepia.vercel.app', tags: ['Next.js 14','Supabase Auth','Recharts','TypeScript'], accent: '#6366F1', bg: 'linear-gradient(135deg,#060914,#0F1B3D)' },
  { emoji: '🛒', name: 'Axon Store', label: 'E-commerce + Stripe', desc: 'Premium tech accessories store with real Stripe payments, localStorage cart, product filtering, and complete checkout-to-success flow.', url: 'https://axonstores.vercel.app', tags: ['Next.js 14','Stripe','Supabase','Cart'], accent: '#F59E0B', bg: 'linear-gradient(135deg,#1C1200,#3D2800)' },
  { emoji: '🏠', name: 'GreyHaven', label: 'Property Management + AI', desc: 'Enterprise property platform with AI chatbot assistant, digital lease signing, Gmail API email automation and SQLite database.', url: 'https://greyhaven-fvla.onrender.com', tags: ['Node.js','Express','SQLite','Groq AI','Gmail API'], accent: '#7FFFC4', bg: 'linear-gradient(135deg,#0A1422,#162040)' },
];
